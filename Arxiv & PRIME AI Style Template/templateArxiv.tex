...
\\ \\
The \textit{Log-Spectral Distance} (LSD) was used to indicate the efficiency of the filter by taking the original signal $z_n$ and the filtered audio signal $z''_n$ into account:
	\begin{equation}
...
\\ \\
The \textit{Definition Ratio}, D50, is the ratio of early to total energy within 50 ms. It was used to indicate if early reverberations are present in the impulse response.
\\ \\
...
\hline
PESQ &    4.4202   &    4.5314    &    4.6308    &    4.6337   \\
\hline
$\Delta$ PESQ &      \multicolumn{2}{c|}{$0.1112$}      &      \multicolumn{2}{c|}{$2.9 \cdot 10^{-3}$}       \\
\hline
...
no noise was added or subtracted to the speech sample due to filtering, so the intelligibility stayed as good as originally recorded.
