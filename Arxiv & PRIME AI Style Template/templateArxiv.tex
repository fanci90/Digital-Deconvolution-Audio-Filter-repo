...
The time domain \textit{impulse response}, e.g. from equation \eqref{eq:IR}, is transformed by STFT, to decay frequency bins basef on blind $T60$ estimate. 
...
\\ \\
The \textit{Definition Ratio}, D50, is the ratio of early to total energy within 50 ms \cite{HoutgastSteeneken1985}. It was used to indicate if early reverberations are present in the impulse response.
\\ \\
